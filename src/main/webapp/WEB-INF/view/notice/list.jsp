...
<script src="../js/notice/list.js?ver=1"></script>
</head>
   ...
   <div id="body">
      ...
      <div class="content-box">
                        ...
                        <c:forEach var="n"  varStatus="status" items="${list}" >
                           ...
                           <c:if test="${status.count%2 !=0}">
                              <tr>
                                 ...
                                 <td class="title"><a href="detail?id=${n.id}">${status.index}-${status.count} ${n.title}</a></td>
         ...
         <div id="test-pager">
            ...
            <input class="btn1" type="button" value="요청">
         </div>
         ...
         <section id="pager">
            ...
            <div>
               ...
               <div><a href="list?p=${(page<6)?page:page-5}">이전</a></div>
               <ul>         
               ...
               <div><a href="list?p=${page+5}">다음</a></div>
            </div>
         </section>
         </main>
